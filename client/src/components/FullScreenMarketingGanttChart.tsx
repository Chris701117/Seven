...
interface FullScreenMarketingGanttChartProps {
  tasks: MarketingTask[];
  open: boolean;
  onClose: () => void;
}
...
export default function FullScreenMarketingGanttChart({ tasks, open, onClose }: FullScreenMarketingGanttChartProps) {
    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-[95vw] w-[95vw] max-h-[90vh] h-[90vh] p-0 overflow-hidden flex flex-col">
        <DialogHeader className="flex flex-row items-center justify-between p-4 border-b">
          <DialogTitle className="text-xl font-bold">行銷管理甘特圖 - 全屏視圖</DialogTitle>
          <DialogClose asChild>
