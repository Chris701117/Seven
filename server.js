...
const tools = {
  ...
  getNavigationMenu: async () => { /* ... 程式碼省略，與上一版相同 ... */ },
  updateNavigationMenu: async ({ menuItems }) => { /* ... 程式碼省略，與上一版相同 ... */ },
  ...
  postToFacebookPage: async ({ message, link }) => { /* ... 程式碼省略，與上一版相同 ... */ },
  getFacebookLatestPostInsights: async () => { /* ... 程式碼省略，與上一版相同 ... */ },
};
