...
export enum Permission {
  ...
  VIEW_USERS = 'VIEW_USERS',  // 查看用戶列表權限
  ...
  VIEW_MARKETING_TASKS = 'VIEW_MARKETING_TASKS',  // 查看行銷任務權限
  ...
  VIEW_OPERATION_TASKS = 'VIEW_OPERATION_TASKS',  // 查看營運任務權限
  ...
  VIEW_ONELINK = 'VIEW_ONELINK',  // 查看Onelink權限
  
  // 設定管理
  MANAGE_SETTINGS = 'MANAGE_SETTINGS',
  VIEW_SETTINGS = 'VIEW_SETTINGS',  // 查看設定權限
  
  // 用戶群組管理
  MANAGE_USER_GROUPS = 'MANAGE_USER_GROUPS',  // 管理用戶群組權限
  VIEW_USER_GROUPS = 'VIEW_USER_GROUPS',  // 查看用戶群組權限
}
